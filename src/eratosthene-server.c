 ...
 */
    ...
    le_server_t le_server_create2( le_size_t const le_port, le_char_t const * const le_path ) {
    ...
    le_void_t le_server_delete2( le_server_t * const le_server ) {
 ...
 */
    ...
    le_void_t le_server2( le_server_t * const le_server ) {
