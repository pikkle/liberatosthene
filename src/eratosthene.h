 ...
 */
     ...
     *  storage and access. This allows servers developed using this library to
     *  perform data injection and query with high efficiency over the network
     *  to provide 4D geographic services and information systems.
     *
     *  From a theoretical point of view, any type of point-based data, as
     *  referenced in space and time, can be considered through the index
     *  formalism. Currently, colours are considered as data. This allows
     *  servers built on this library to broadcast large amount of colorimetric
     *  points over the network, toward large and multiscale 4D geographic
     *  services information systems at earth scale.
     *
 ...
 */
    ...
    # define _LE_MASK            uint64_t /* delete */
 ...
 */
    ...
    typedef _LE_MASK le_mask_t; /* delete */
